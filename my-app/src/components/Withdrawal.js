...
const WithdrawForm = () => {
    ...
    return (
    <div style={{marginLeft: '40px', boxShadow: '0px 0px 10px rgba(0, 0, 0, 0.2)', marginRight: '50px', marginTop: '0px', padding: '20px', border: '1px solid #ccc', borderRadius: '5px', backgroundColor: 'white' }}>
        <Typography variant="h5" gutterBottom style={{ color: blueColor, fontWeight: 'bold' }}>Withdrawal</Typography>
        ...
        <form onSubmit={handleWithdraw}>
            <Grid container spacing={2} alignItems="center">
                    ...
                    <Grid item xs={12}>
                        <Button type="submit" variant="contained" color="primary" fullWidth>Withdraw</Button>
                    </Grid>
            </Grid>
        </form>
    </div>
